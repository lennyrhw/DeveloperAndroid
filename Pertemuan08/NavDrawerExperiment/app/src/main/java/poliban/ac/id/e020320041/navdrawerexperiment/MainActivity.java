package poliban.ac.id.e020320041.navdrawerexperiment;
...
import poliban.ac.id.e020320041.navdrawerexperiment.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setTitle("NavDreawerExperiment - Intan");
