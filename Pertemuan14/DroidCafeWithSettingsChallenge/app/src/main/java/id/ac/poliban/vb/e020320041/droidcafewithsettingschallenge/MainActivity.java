package id.ac.poliban.vb.e020320041.droidcafewithsettingschallenge;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.vb.e020320041.droidcafewithsettingschallenge.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("DroidCafeSettingChallenge - Lenny");
